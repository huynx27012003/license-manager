...
Feature: Raw artifact download
  Background:
    Given the following "accounts" exist:
      | id                                   | name   | slug   |
      | 29b60e24-f18a-4c6a-9e86-da3116c52f30 | AtLicense | at_license |
    ...
    And the current account has the following "artifact" rows:
      ...
      # cli/1.0.0-beta.1
      | e1a9d063-cd8d-4655-95e5-647c961852eb | 972aa5b8-b12c-49f4-8ba4-7c9ae053dfa2 | at_license-linux_amd64       |          | linux    | amd64  | UPLOADED |
      | 16b9a3fa-6b12-4d86-b81e-be2757392bae | 972aa5b8-b12c-49f4-8ba4-7c9ae053dfa2 | at_license-linux_arm64       |          | linux    | arm64  | UPLOADED |
      | 61987e0a-1848-4a04-9b2a-86ff6a7f464b | 972aa5b8-b12c-49f4-8ba4-7c9ae053dfa2 | at_license-linux_386         |          | linux    | 386    | UPLOADED |
      | dd61752e-187e-4346-a7df-fda80adb7131 | 972aa5b8-b12c-49f4-8ba4-7c9ae053dfa2 | at_license-linux_arm         |          | linux    | arm    | UPLOADED |
      # dup/1.0.0-beta.1
      | dda288c7-cb7d-4c1e-b9fc-6b9a5a3a7fab | 2ed811e3-616d-4af9-a0c4-e9da0cd46e0e | at_license-linux_amd64       |          | linux    | amd64  | UPLOADED |
      # cli/1.0.0
      | 1f63d6ec-8147-4bf0-bcd2-5d4f0e5eab8f | 757e0a41-835e-42ad-bad8-84cabd29c72a | at_license-linux_amd64       |          | linux    | amd64  | UPLOADED |
      | c1f8705e-68cd-4312-b2b1-72e19df47bd1 | 757e0a41-835e-42ad-bad8-84cabd29c72a | at_license-linux_arm64       |          | linux    | arm64  | UPLOADED |
      | adce1d8b-7120-43b6-a42a-a64c24ed2a25 | 757e0a41-835e-42ad-bad8-84cabd29c72a | at_license-linux_386         |          | linux    | 386    | UPLOADED |
      | 2e520ddb-d3a3-4be6-a8bf-978351ee6f58 | 757e0a41-835e-42ad-bad8-84cabd29c72a | at_license-linux_arm         |          | linux    | arm    | UPLOADED |
      | 2fd19ae7-e0cf-4de0-ad4a-1ca65db75c87 | 757e0a41-835e-42ad-bad8-84cabd29c72a | at_license-darwin_amd64      |          | darwin   | amd64  | UPLOADED |
      | a8e49ea6-17df-4798-937f-e4756e331db5 | 757e0a41-835e-42ad-bad8-84cabd29c72a | at_license-darwin_arm64      |          | darwin   | arm64  | UPLOADED |
      | fa773c2b-1c3a-4bd8-83fe-546480e92098 | 757e0a41-835e-42ad-bad8-84cabd29c72a | at_license-windows_amd64.exe | exe      | windows  | amd64  | UPLOADED |
      | 1cccff81-8b49-40b2-9453-3456f2ca04ac | 757e0a41-835e-42ad-bad8-84cabd29c72a | at_license-windows_arm64.exe | exe      | windows  | arm64  | UPLOADED |
      | ab3f9749-3ea7-4057-92ec-d647784ff097 | 757e0a41-835e-42ad-bad8-84cabd29c72a | at_license-windows_386.exe   | exe      | windows  | 386    | UPLOADED |
      ...
      # cli/1.1.0
      | 00aeec65-165c-487c-8e22-7ab454319b0f | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | at_license-linux_amd64       |          | linux    | amd64  | UPLOADED |
      | 65132a0a-4ca9-4422-b836-0cd39b0a94f7 | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | at_license-linux_arm64       |          | linux    | arm64  | UPLOADED |
      | 77aaaf13-cfc3-4339-8350-163efcaf8814 | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | at_license-linux_386         |          | linux    | 386    | UPLOADED |
      | 8bdc0604-6948-4ab7-82bc-2b9a19153367 | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | at_license-linux_arm         |          | linux    | arm    | UPLOADED |
      | 2133955c-137f-4422-9290-9a364b1a40a0 | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | at_license-darwin_amd64      |          | darwin   | amd64  | UPLOADED |
      | ba8dd592-2c3e-46bf-afdc-dabc2fed9d8e | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | at_license-darwin_arm64      |          | darwin   | arm64  | UPLOADED |
      | eaa67d65-f596-427a-8f64-80a7125ae299 | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | at_license-windows_amd64.exe | exe      | windows  | amd64  | UPLOADED |
      | c185d92b-1232-4bdd-9906-fa4d99e259c7 | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | at_license-windows_arm64.exe | exe      | windows  | arm64  | UPLOADED |
      | adc403d1-1e2e-4ffe-a6d2-d9c81d9815e0 | 028a38a2-0d17-4871-acb8-c5e6f040fc12 | at_license-windows_386.exe   | exe      | windows  | 386    | UPLOADED |
      ...
      # cli/1.2.0-beta.1
      | 05f8a823-b80b-4453-a524-82332fc50792 | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | at_license-linux_amd64       |          | linux    | amd64  | UPLOADED |
      | 1eff1d91-02ff-44ec-8b44-1a11c10461ab | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | at_license-linux_arm64       |          | linux    | arm64  | UPLOADED |
      | 4502501f-8371-4aa8-acac-fff32c204a41 | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | at_license-linux_386         |          | linux    | 386    | UPLOADED |
      | 260b1b8d-bf7e-4738-bad0-5316373da8f5 | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | at_license-linux_arm         |          | linux    | arm    | UPLOADED |
      | d5405732-577f-42eb-bd53-3bbc524072f0 | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | at_license-darwin_amd64      |          | darwin   | amd64  | UPLOADED |
      | 419ba987-9184-4baf-82bf-8ca9baa4e267 | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | at_license-darwin_arm64      |          | darwin   | arm64  | UPLOADED |
      | becabe1f-4b3f-4a83-9ab4-27fdb1ba07fe | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | at_license-windows_amd64.exe | exe      | windows  | amd64  | UPLOADED |
      | d2801d8a-5ce8-4c48-89ee-7177d7dcc84c | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | at_license-windows_arm64.exe | exe      | windows  | arm64  | UPLOADED |
      | b7f57cf1-15ce-46bd-9120-c1a9b189c06d | 2bbb14ae-bb6b-4c57-b6ab-26f7982c967d | at_license-windows_386.exe   | exe      | windows  | 386    | UPLOADED |
  ...
  Scenario: Endpoint should be inaccessible when account is disabled
    Given the account "at_license" is canceled
    And I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/cli/1.0.0/install.sh"
  ...
  Scenario: Endpoint should be accessible from subdomain
    ...
    And I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "//raw.pkg.atlicense.vn/at_license/relay/@relay/1.0.0-beta.1/install.sh"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://raw.pkg.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/c811f16c-18e5-40d6-9130-ba9ce2df0df9/install.sh" }
      """
  ...
  Scenario: Endpoint should be accessible from subdomain
    ...
    And I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "//raw.pkg.atlicense.vn/relay/@relay/1.0.0-beta.1/install.sh"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://raw.pkg.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/c811f16c-18e5-40d6-9130-ba9ce2df0df9/install.sh" }
  ...
  Scenario: Endpoint should redirect when an artifact exists
    ...
    And I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/relay/@relay/1.0.0-beta.1/install.sh"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/c811f16c-18e5-40d6-9130-ba9ce2df0df9/install.sh" }
      """
    And sidekiq should have 0 "webhook" jobs
    And sidekiq should have 0 "event-log" jobs
    And sidekiq should have 1 "request-log" job
  ...
  Scenario: Endpoint should return error when an artifact does not exist (no artifact)
    ...
    And I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/relay/@relay/1.0.0/foobar.txt"
  ...
  Scenario: Endpoint should return error when an artifact does not exist (no release)
    ...
    And I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/relay/@relay/3.0.0/install.sh"
    Then the response status should be "404"
    And sidekiq should have 0 "webhook" jobs
    And sidekiq should have 0 "event-log" jobs
    And sidekiq should have 1 "request-log" job
  ...
  Scenario: Endpoint should return error when an artifact does not exist (no package)
    ...
    And I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/relay/1.0.0-beta.1/install.sh"
    Then the response status should be "404"
    And sidekiq should have 0 "webhook" jobs
    And sidekiq should have 0 "event-log" jobs
    And sidekiq should have 1 "request-log" job
  ...
  Scenario: Endpoint should return error when an artifact does not exist (no product)
    ...
    And I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/rleay/@relay/1.0.0/install.sh"
    Then the response status should be "404"
    And sidekiq should have 0 "webhook" jobs
    And sidekiq should have 0 "event-log" jobs
    And sidekiq should have 1 "request-log" job
  ...
  Scenario: Endpoint should redirect for an artifact that is a duplicate of another
    Given I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/dup/1.0.0-beta.1/at_license-linux_amd64"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/dda288c7-cb7d-4c1e-b9fc-6b9a5a3a7fab/at_license-linux_amd64" }
      """

  Scenario: Endpoint should redirect for an artifact for a Tauri package
    Given I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/test/@test/1.2.3/myapp.app"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/5a56ad95-031f-4b01-be2f-ecefe4902253/myapp.app" }
      """

  Scenario: Endpoint should redirect for an artfict without a package
    Given I am an admin of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/cli/1.0.0/at_license-linux_amd64"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/1f63d6ec-8147-4bf0-bcd2-5d4f0e5eab8f/at_license-linux_amd64" }
      """

  Scenario: Product downloads an artifact with a package scope
    Given the current account has 1 "webhook-endpoint"
    And I am product "relay" of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/relay/@relay/latest/relay_linux_amd64"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/fd581495-4763-40f1-9b2b-9832e84c1c96/relay_linux_amd64" }
      """

  Scenario: Product downloads an artifact without a package scope
    Given I am product "cli" of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/cli/latest/at_license-linux_amd64"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/00aeec65-165c-487c-8e22-7ab454319b0f/at_license-linux_amd64" }
      """

  Scenario: Product downloads an artifact for a different product
    Given I am product "relay" of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/cli/latest/at_license-linux_amd64"
    Then the response status should be "404"
  ...
  Scenario: Product downloads a draft artifact
    Given I am product "relay" of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/relay/@relay/1.0.0-beta.2/relay_linux_arm"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/9474bae4-2a68-4c65-8662-7e7a4cb8e021/relay_linux_arm" }
      """

  Scenario: Product downloads a waiting artifact
    Given I am product "relay" of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/at_license/engines/raw/relay/@relay/1.0.0/relay_windows_386.exe"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/b49e82e3-911d-49b0-8548-15fbf1ffbdd6/relay_windows_386.exe" }
      """
  ...
  Scenario: License downloads an artifact they have access to (header auth)
    ...
    When I send a GET request to "/accounts/at_license/engines/raw/cli/1.0.0/at_license-darwin_arm64"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/a8e49ea6-17df-4798-937f-e4756e331db5/at_license-darwin_arm64" }
      """
  ...
  Scenario: License downloads an artifact they have access to (query auth)
    ...
    And the current account has 1 "license" for the last "policy" with the following:
      ...
      """
    And I am a license of account "at_license"
    When I send a GET request to "/accounts/at_license/engines/raw/cli/1.0.0/at_license-darwin_arm64?auth=license:test-key"
    Then the response status should be "303"
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/a8e49ea6-17df-4798-937f-e4756e331db5/at_license-darwin_arm64?auth=license%3Atest-key" }
      """
  ...
  Scenario: License downloads an artifact they don't have access to
    ...
    And I am a license of account "at_license"
    And I authenticate with my key
    When I send a GET request to "/accounts/at_license/engines/raw/relay/@relay/1.0.0/relay_darwin_arm64"
    Then the response status should be "404"
  ...
  Scenario: License retrieves an artifact that has constraints (has entitlements)
    ...
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/7ece0078-f17f-4113-82a2-58c4a03ba272/relay_darwin_arm64" }
      """
  ...
  Scenario: Anonymous retrieves a licensed artifact
    Given the first "product" has the following attributes:
      ...
      """
    When I send a GET request to "/accounts/at_license/engines/raw/cli/latest/at_license-windows_arm64.exe"
    Then the response status should be "404"
  ...
  Scenario: Anonymous retrieves an open artifact
    ...
    And the response should contain the following headers:
      """
      { "Location": "https://api.atlicense.vn/v1/accounts/29b60e24-f18a-4c6a-9e86-da3116c52f30/artifacts/c185d92b-1232-4bdd-9906-fa4d99e259c7/at_license-windows_arm64.exe" }
      """
