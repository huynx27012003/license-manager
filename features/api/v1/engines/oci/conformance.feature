...
Feature: OCI spec conformance
  ...
  Scenario: Endpoint should pass conformance ack (trailing slash)
    ...
    When I send a GET request to "//oci.pkg.atlicense.vn/v2/"
  ...
  Scenario: Endpoint should fail referrers
    Given I am an admin of account "linux"
    And I use an authentication token
    When I send a GET request to "//oci.pkg.atlicense.vn/v2/linux/alpine/referrers/foo"
  ...
  Scenario: Endpoint should fail upload
    Given I am an admin of account "linux"
    And I use an authentication token
    When I send a POST request to "//oci.pkg.atlicense.vn/v2/linux/alpine/blobs/uploads"
    Then the response status should be "405"
  ...
  Scenario: Endpoint should fail yank
    Given I am an admin of account "linux"
    And I use an authentication token
    When I send a DELETE request to "//oci.pkg.atlicense.vn/v2/linux/alpine/manifests/3.20.2"
    Then the response status should be "405"
  ...
  Scenario: Endpoint should fail referrers
    Given I am an admin of account "linux"
    And I use an authentication token
    When I send a GET request to "//oci.pkg.atlicense.vn/v2/alpine/referrers/foo"
    Then the response status should be "405"
  ...
  Scenario: Endpoint should fail upload
    Given I am an admin of account "linux"
    And I use an authentication token
    When I send a POST request to "//oci.pkg.atlicense.vn/v2/alpine/blobs/uploads"
    Then the response status should be "405"
  ...
  Scenario: Endpoint should fail yank
    Given I am an admin of account "linux"
    And I use an authentication token
    When I send a DELETE request to "//oci.pkg.atlicense.vn/v2/alpine/manifests/3.20.2"
    Then the response status should be "405"
