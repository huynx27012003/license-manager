...
Feature: OCI image blobs
  ...
  Scenario: Endpoint should be accessible from subdomain
    ...
    And I am an admin of account "linux"
    And I use an authentication token
    When I send a GET request to "//oci.pkg.atlicense.vn/v2/linux/alpine/blobs/sha256:43c4264eed91be63b206e17d93e75256a6097070ce643c5e8f0379998b44f170"
  ...
  Scenario: Endpoint should be accessible from subdomain
    ...
    And I am an admin of account "linux"
    And I use an authentication token
    When I send a GET request to "//oci.pkg.atlicense.vn/v2/alpine/blobs/sha256:43c4264eed91be63b206e17d93e75256a6097070ce643c5e8f0379998b44f170"
    Then the response status should be "303"
  ...
  Scenario: Endpoint should pass blob ack
    ...
    And I am an admin of account "linux"
    And I use an authentication token
    When I send a HEAD request to "//oci.pkg.atlicense.vn/v2/linux/alpine/blobs/sha256:43c4264eed91be63b206e17d93e75256a6097070ce643c5e8f0379998b44f170"
  ...
  Scenario: Endpoint should fail blob ack
    ...
    And I am an admin of account "linux"
    And I use an authentication token
    When I send a HEAD request to "//oci.pkg.atlicense.vn/v2/linux/alpine/blobs/foo"
  ...
  Scenario: Endpoint should pass blob ack
    ...
    And I am an admin of account "linux"
    And I use an authentication token
    When I send a HEAD request to "//oci.pkg.atlicense.vn/v2/alpine/blobs/sha256:43c4264eed91be63b206e17d93e75256a6097070ce643c5e8f0379998b44f170"
    Then the response status should be "200"
  ...
  Scenario: Endpoint should fail blob ack
    ...
    And I am an admin of account "linux"
    And I use an authentication token
    When I send a HEAD request to "//oci.pkg.atlicense.vn/v2/alpine/blobs/foo"
    Then the response status should be "404"
  ...
  Scenario: Endpoint should return a layout blob by digest
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/14c038fd-b57e-432d-8c09-f50ebcd6a7bc/artifacts/5762c549-7f5b-4a73-9873-3acdb1213fe8/oci-layout
      """
  ...
  Scenario: Endpoint should return an index blob by digest
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/14c038fd-b57e-432d-8c09-f50ebcd6a7bc/artifacts/5762c549-7f5b-4a73-9873-3acdb1213fe8/index.json
      """
  ...
  Scenario: Endpoint should return a manifest blob by digest
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/14c038fd-b57e-432d-8c09-f50ebcd6a7bc/artifacts/5762c549-7f5b-4a73-9873-3acdb1213fe8/blobs%2Fsha256%2F33735bd63cf84d7e388d9f6d297d348c523c044410f553bd878c6d7829612735
      """
  ...
  Scenario: Endpoint should return a layer blob by digest
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/14c038fd-b57e-432d-8c09-f50ebcd6a7bc/artifacts/5762c549-7f5b-4a73-9873-3acdb1213fe8/blobs%2Fsha256%2F43c4264eed91be63b206e17d93e75256a6097070ce643c5e8f0379998b44f170
      """
  ...
  Scenario: Endpoint should return an image blob by digest
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/14c038fd-b57e-432d-8c09-f50ebcd6a7bc/artifacts/5762c549-7f5b-4a73-9873-3acdb1213fe8/blobs%2Fsha256%2F91ef0af61f39ece4d6710e465df5ed6ca12112358344fd51ae6a3b886634148b
      """
  ...
  Scenario: Product retrieves their draft blob
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/9f3d711d-55ea-49ed-9155-9acf4e4a347b/artifacts/2e8fc5fb-a57f-49e2-9484-77bb421dc758/blobs%2Fsha256%2F40f923622162df3ece7602a0d41ee7920aaf3c978ca9e9f9aa4dc7b34af2e229
      """
  ...
  Scenario: Product retrieves their yanked blob
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/9f3d711d-55ea-49ed-9155-9acf4e4a347b/artifacts/2da1858d-49eb-47e0-94cc-a94a0bba9453/blobs%2Fsha256%2F07f83d6bdf77359ea8d23fbb11ae297a9c8f4a85fe0403e34106353b04ae8b15
      """
  ...
  Scenario: Product retrieves their licensed blob
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/14c038fd-b57e-432d-8c09-f50ebcd6a7bc/artifacts/74ad090a-7cee-4227-96bc-4af939e8bfa7/index.json
      """
  ...
  Scenario: Product retrieves another account's open manifest
    ...
    And I am product "at_license" of account "at_license"
    And I use an authentication token
    When I send a GET request to "/accounts/linux/engines/oci/alpine/blobs/sha256:355eee6af939abf5ba465c9be69c3b725f8d3f19516ca9644cf2a4fb112fd83b"
  ...
  Scenario: Product retrieves a blob with common digest
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/14c038fd-b57e-432d-8c09-f50ebcd6a7bc/artifacts/c557e7f4-80fc-4fa1-bbbc-a8fc1a37a733/oci-layout
      """
  ...
  Scenario: License retrieves a blob for their product (unentitled)
    ...
    When I send a GET request to "/accounts/at_license/engines/oci/api/blobs/sha256:63179218e5dab1bc90d0580256c5a3bf3b117de72c65d1841d49b283934b2179"
    Then the response status should be "403"
    And the first error should have the following properties:
      """
      {
  ...
  Scenario: License retrieves a blob for their product (entitled)
    ...
    And the response should contain the following raw headers:
      """
      Location: https://api.atlicense.vn/v1/accounts/b8cd8416-6dfb-44dd-9b69-1d73ee65baed/artifacts/89d95ffe-7785-465a-bc26-2da411fe6e99/index.json
      """
