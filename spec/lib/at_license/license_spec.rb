...
describe AtLicense::EE::License, type: :ee do
  ...
  context 'when using an expired license file' do
    with_file path: AtLicense::EE::LicenseFile::DEFAULT_PATH, fixture: 'expired.lic' do
      with_env AT_LICENSE_LICENSE_KEY: license_key do
        ...
        it 'should raise outside grace period' do
          ...
          with_time license.expiry + 31.days do
            expect { license.valid? }.to raise_error AtLicense::EE::ExpiredLicenseError
          end
        end
  ...
  context 'when using an invalid license file' do
    with_env AT_LICENSE_LICENSE_FILE_PATH: '/dev/null', AT_LICENSE_LICENSE_KEY: license_key do
      it 'should fail to load license' do
        ...
        expect { license.valid? }.to raise_error AtLicense::EE::InvalidLicenseFileError
      end
    end
  end

  context 'when using an invalid license key' do
    with_env AT_LICENSE_LICENSE_FILE: license_file, AT_LICENSE_LICENSE_KEY: 'invalid' do
      it 'should fail to load license' do
        license = described_class.current
