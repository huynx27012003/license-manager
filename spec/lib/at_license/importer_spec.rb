...
describe AtLicense::Importer do
  ...
  it 'should not raise for valid io', :ignore_potential_false_positives do
    expect { AtLicense::Importer.import(account_id:, from: StringIO.new) }
      .to_not raise_error ArgumentError
  end

  it 'should raise for invalid io' do
    expect { AtLicense::Importer.import(account_id:, from: '') }
      .to raise_error ArgumentError
  end

  it 'should not raise for valid version 1' do
    expect { AtLicense::Importer.import(account_id:, from: StringIO.new(1.chr)) }
      .to_not raise_error
  end

  it 'should raise for invalid version' do
    expect { AtLicense::Importer.import(account_id:, from: StringIO.new(42.chr)) }
      .to raise_error AtLicense::Importer::UnsupportedVersionError
  end
  ...
  it 'should raise for invalid data' do
    ...
    expect { AtLicense::Importer.import(account_id:, from: StringIO.new(1.chr + size + data)) }
      .to raise_error AtLicense::Importer::InvalidDataError
  end
  ...
  it 'should raise for invalid chunk' do
    ...
    expect { AtLicense::Importer.import(account_id:, from: StringIO.new(1.chr + size + data)) }
      .to raise_error AtLicense::Importer::InvalidChunkError
  end
  ...
  context 'with encryption' do
    ...
    it 'should import with valid secret key' do
      export = AtLicense::Exporter.export(account, secret_key:)
      ...
      expect { AtLicense::Importer.import(from: export, account_id:, secret_key:) }.to change { Account.count }.by(1)
    ...
    it 'should raise with invalid secret key' do
      ...
      expect { AtLicense::Importer.import(from: export, secret_key: 'invalid', account_id:) }
        .to raise_error AtLicense::Importer::InvalidSecretKeyError
    end
  end
  ...
  context 'without encryption' do
    ...
    it 'should import without secret key' do
      export = AtLicense::Exporter.export(account)
      ...
      expect { AtLicense::Importer.import(from: export, account_id:) }.to change { Account.count }.by(1)
        .and change { User.count }.by(user_count_was)
        .and change { License.count }.by(license_count_was)
        .and change { Machine.count }.by(machine_count_was)
    end
  ...
  context 'with invalid account' do
    ...
    it 'should raise for unexpected account' do
      ...
      expect { AtLicense::Importer.import(from: export, account_id: SecureRandom.uuid) }
        .to raise_error AtLicense::Importer::InvalidAccountError
    end

    it 'should raise for duplicate account' do
      export = AtLicense::Exporter.export(account)

      expect { AtLicense::Importer.import(from: export, account_id:) }
        .to raise_error AtLicense::Importer::DuplicateRecordError
    end

    it 'should raise for multiple accounts' do
      export_a = AtLicense::Exporter.export(account)
      export_b = AtLicense::Exporter.export(other_account)
  ...
  context 'with invalid record' do
    ...
    it 'should raise for invalid record' do
      ...
      expect { AtLicense::Importer.import(from: export, account_id:) }
        .to raise_error AtLicense::Importer::InvalidRecordError
    end
    ...
    it 'should raise on unsupported record' do
      ...
      chunk      = AtLicense::Exporter::V1::Serializer.new.serialize(Plan.name, [{ id: SecureRandom.uuid }])
      ...
      expect { AtLicense::Importer.import(from: export, account_id:) }
        .to raise_error AtLicense::Importer::UnsupportedRecordError
    end
  end
end
